...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { age: @gift.age, description: @gift.description, gender: @gift.gender, title: @gift.title }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { age: @gift.age, description: @gift.description, gender: @gift.gender, title: @gift.title }
    assert_redirected_to gift_path(assigns(:gift))
  end
